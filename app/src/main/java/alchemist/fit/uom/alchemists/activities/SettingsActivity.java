...
public class SettingsActivity extends AppCompatActivity {
        ...
        alertDialogBuilder.setPositiveButton("yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        showProgressDialog();
                        new SettingsActivity.DeleteAccountAsyncTask().execute(Constants.localAddress + "rest/ureportservice/deleteUser?user_id=" + URLEncoder.encode(sharedPrefUserId));
                    }
                });
    ...
    private class DeleteAccountAsyncTask extends AsyncTask<String, Void, String> {
        @Override
        ...
        protected void onPostExecute(String result) {
            ...
            switch (result) {
                case "deleted":
                    alchemistsDataSource.deleteTableUserDetails();
                    break;
                case "404":
    ...
    private void showProgressDialog() {
        progressDialog = new ProgressDialog(SettingsActivity.this,R.style.MyAlertDialogStyle);
        progressDialog.setMessage("Wait until deleting account!"); // Setting Message
