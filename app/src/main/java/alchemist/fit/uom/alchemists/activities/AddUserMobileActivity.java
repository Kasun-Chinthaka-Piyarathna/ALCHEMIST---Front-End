...
public class AddUserMobileActivity extends AppCompatActivity {
    ...
    public void confirmUserMobile(View view) {
        ...
        if (userMobileTxt.equals("") || userMobileTxt.equals(null)) {
            ...
            showProgressDialog();
            new AddUserMobileActivity.AddUserMobileAsyncTask().execute(Constants.localAddress + "rest/ureportservice/updateMobile?user_id=" + URLEncoder.encode(sharedPrefUserId) + "&mobile=" + URLEncoder.encode(userMobileTxt));
        }
    }


    private void showProgressDialog() {
        progressDialog = new ProgressDialog(AddUserMobileActivity.this,R.style.MyAlertDialogStyle);
    ...
    private class AddUserMobileAsyncTask extends AsyncTask<String, Void, String> {
        @Override
        ...
        protected void onPostExecute(String result) {
            ...
            switch (result) {
                case "Updated":
                    finish();
                    Intent intent = new Intent(AddUserMobileActivity.this, EditProfileActivity.class);
                    alchemistsDataSource.updateUserDetails(null, null, userMobileTxt,
