...
public class AddUserBirthdayActivity extends AppCompatActivity {
    private String userBirthdayTxt;
    ...
    private int year=1990, month=02, day=22;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_user_birthday);
        addBirthdayButton=findViewById(R.id.activity_add_user_birthday_button);
    ...
    private void showDate(int year, int month, int day) {
        ...
        addBirthdayButton.setText("D:"+day+"|M:"+month+"|Y:"+year+"|");

    }

    public void confirmUserBirthday(View view) {
        userBirthdayTxt = addBirthdayButton.getText().toString();

        if (userBirthdayTxt.equals("") || userBirthdayTxt.equals(null)) {
            Toast.makeText(this, "Please enter a birthday", Toast.LENGTH_SHORT).show();
        } else {

            alchemistsDataSource.updateUserDetails(null, null, null,
                    sharedPrefEmailAddress, null,null,
                    null,null,null,userBirthdayTxt,null);
            ...
            finish();
            Intent intent = new Intent(AddUserBirthdayActivity.this, EditProfileActivity.class);
...
//            new AddUserBirthdayActivity.AddUserBirthdayAsyncTask().execute(Constants.localAddress + "rest/ureportservice/updateMobile?user_id=" + URLEncoder.encode(sharedPrefUserId) + "&mobile=" + URLEncoder.encode(userBirthdayTxt));
    ...
    public void dynamicBehaviourBasedOnAgeGender(int age, String gender) {
        if (!(gender == null || gender.isEmpty() || age == 0)) {
            ...
            Toast.makeText(AddUserBirthdayActivity.this, "This feature is only available once you filled your profile data.", Toast.LENGTH_SHORT).show();
        }
    }


    private void showProgressDialog() {
        progressDialog = new ProgressDialog(AddUserBirthdayActivity.this,R.style.MyAlertDialogStyle);
    ...
    private class AddUserBirthdayAsyncTask extends AsyncTask<String, Void, String> {
        @Override
    ...
    public void activityAddUserBirthdayCancel(View view) {
        finish();
